...
const JobCardList = memo<ReactProps>(function JobCardList(props) {
  return (
    ...
    >
      {JOB_LIST.map((j) => {
        const news =
          (j.company, News[News.findIndex((n) => n.company === j.company)]);
        return news ? (
          // <JobNewsletter
          //   key={j.company}
          //   datum={j}
...
const News: Newsletter[] = [
  ...
  },
  {
    ...
    company: "Futuresai",
    title:
      "Revamp to New React with Complex Strategy Development and Collaborative Roles",
    subtitle: [
