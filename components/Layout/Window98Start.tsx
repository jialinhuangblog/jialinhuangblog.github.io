...
import { ai, flex, jc } from '~/modules/styling/flex'

const Window98Start = memo<ReactProps<{ color: string }>>(function Window98Start(props) {
    ...
    >
      ...
      >
        ...
        <div css={flex.v.default}>
          ...
          <div css={menuItemCss}>Cancel</div>
        </div>
      </div>
    </div>
  )
